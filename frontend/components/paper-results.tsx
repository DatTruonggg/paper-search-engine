  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-4 border-b border-slate-200 bg-gradient-to-r from-green-50/50 to-emerald-50/50">
        ...
        <p className="text-sm text-slate-600 mt-1">{papers.length} papers found</p>
      </div>
      ...
      <ScrollArea className="flex-1">
        <div className="p-4 space-y-4">
          {papers.length === 0 ? (
            ...
            papers.map((paper) => (
              <Card key={paper.id} className="hover:shadow-lg transition-all duration-200 border-slate-200 hover:border-green-300">
                ...
                <CardContent className="pt-0 space-y-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full justify-center gap-2 bg-white hover:bg-green-50 border-slate-200 hover:border-green-300 hover:text-green-700 transition-colors duration-200"
